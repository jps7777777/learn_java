...
public class ExcelUtils {
     ...
     * @param table 报表信息
     */
    public static void writeExcel(String[][] table,String path,String fileName){
        // 创建工作薄
        ...
        for (int row = 0; row < table.length; row++)
        {
            ...
            {
                // 向工作表中添加数据
                rows.createCell(col).setCellValue(table[row][col]);
            }
        }
        ...
        try {
            xlsStream = new FileOutputStream(new File(path+"\\"+fileName));
