...
public class EncryptUtil {
     ...
     * @return String
     */
    public static String entryptByMd5(String password) throws FinallyException {
        String alt = password+"5js^%96k,ybh";
        StringBuilder stringBuilder = new StringBuilder();
        try {
            byte[] md5s = MessageDigest.getInstance("MD5").digest(alt.getBytes("utf-8"));
            for (byte b : md5s) {
